...
const GlassmorphismBackground: React.FC<GlassmorphismBackgroundProps> = ({
  ...
  return (
    <div
      className={`relative backdrop-blur-md bg-white/40 dark:bg-gray-800/40 rounded-2xl shadow-lg border border-white/30 dark:border-gray-700/30 overflow-hidden h-full ${className}`}
    >
      {/* Top highlight */}
